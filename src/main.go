...
func Main() {
	...
	prompt := flag.String("prompt", "react", "Chat with AI via prompt 'simple', or 'discuss'  or 'react' (reason and act)")
	backend := flag.String("backend", "gpt4", "Select AI backend. Either 'gpt3', 'gpt4', 'orca2', 'mistral', 'gemini'")
	flag.Parse()
